...
# Load and prep data
csv_path = './data/opQA_shuffled_ans-opt.csv' # Update this path as needed
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res1_shuffled_raw.csv" # Update this path as needed
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res2_shuffled_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res3_shuffled_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res4_shuffled_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
