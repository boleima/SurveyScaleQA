...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/results1_raw.csv" # Update this path as needed
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/results2_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/results3_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/results4_raw.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
