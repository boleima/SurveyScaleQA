...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res1_shuff_raw_bm.csv" # Update this path as needed
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res2_shuff_raw_bm.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res3_shuff_raw_bm.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res4_shuff_raw_bm.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
