...
# Load and prep data
csv_path = './data/opinionQA_questions_final.csv'  # Update this path as needed
...
# Model configuration 
local_dir = "./models"  # Path to local model weights, or remove if downloading directly from HF Hub
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res1_raw_base-models.csv" # Update this path as needed
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res2_raw_base-models.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res3_raw_base-models.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
...
## Saving Result ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
output_path = "./data/res4_raw_base-models.csv" # Update this path as needed
results = questions_df.drop(columns=['llm_prompt'])
results.to_csv(output_path, index=False)
print(f"\nResults saved to {output_path}")
